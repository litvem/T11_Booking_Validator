...
mqtt.client.on("message", (topic, message) => {
    ...
    if(!payload.userid || !payload.requestid || !payload.dentistid || !payload.issuance || !payload.date || !payload.name){
    ...
    switch (true) {
        case topic.includes(topics.subsscribeTopic.bookingRequest):
            ...
            (inssuancePQueue.size() < MAX_SIZE) ? inssuancePQueue.enqueue(payload) : console.log("max capacity")
